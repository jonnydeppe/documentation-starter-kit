---
title: Basic Anchor
seoTitle: "How to create a Lunul program with Anchor"
description:
  "How to set up a new Anchor workspace for Lunul program development for
  beginners."
keywords:
  - anchor
  - anchor init
...
- `programs/`: Directory for Lunul program crates.
...
[document](/docs/toolkit/projects/project-layout).
