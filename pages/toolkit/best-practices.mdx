...
description:
  "The best practices for Lunul program development, including: optimize
  compute, fuzzing, repo structure, indexing, and more."
seoTitle: "What are best practices for Lunul program development?"
keywords:
  - lunul best practices
  - program best practices
  - program development
  - program security
  - development best practices
  - smart contract best practices
  - lunul smart contracts
h1: Lunul Program Best Practices
---
...
Saving the bump to your Lunul smart contract account state ensures
...
- [Complete Project Code Example](https://github.com/lunul-developers/developer-bootcamp-2024/blob/main/project-9-token-lottery/programs/token-lottery/src/lib.rs#L291)
