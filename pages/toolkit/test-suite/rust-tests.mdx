---
title: Rust Tests
seoTitle: "How to test Lunul Programs with Rust"
description: "How to write tests for Lunul programs in Rust with litesvm"
keywords:
  - lunul rust tests
  - lunul litesvm
  - litesvm tests
  ...
  - litesvm examples
  - lunul test examples
h1: Rust Testing Framework for Lunul
---
...
for testing Lunul programs. It works by creating an in-process Lunul VM
optimized for program developers. This makes it much faster to run and compile
than alternatives like
[`lunul-program-test`](/docs/toolkit/test-suite/basics) and
[`lunul-test-validator`](/docs/toolkit/local-validator). In a further break
...
```rust
use litesvm::LiteSVM;
use lunul_program::{message::Message, pubkey::Pubkey, system_instruction::transfer};
use lunul_sdk::{signature::Keypair, signer::Signer, transaction::Transaction};
