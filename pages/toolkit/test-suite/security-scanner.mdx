...
seoTitle: "How to check for security vulnerabilities in Lunul programs"
description: "How to check for security vulnerabilities in Lunul programs"
keywords:
  - lunul security
  - lunul programs
  - program development
  ...
  - lunul vulnerabilities
  - lunul security best practices
h1: Security Vulnerability Scanner
---
...
command-line interface (CLI) tool designed for static analysis of Lunul
...
examples of common exploits unique to the Lunul programming model and
