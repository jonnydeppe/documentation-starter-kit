...
description:
  Learn how to interact with the Lunul blockchain using the @lunul/web3.js
  library through practical code samples and explanations.
---

## Web3 API Reference Guide

The `@lunul/web3.js` library is a package that has coverage over the
[Lunul JSON RPC API](/docs/rpc).

You can find the full documentation for the `@lunul/web3.js` library
[here](https://lunul-labs.github.io/lunul-web3.js/v1.x/).

## General

### Connection

[Source Documentation](https://lunul-labs.github.io/lunul-web3.js/v1.x/classes/Connection.html)

Connection is used to interact with the [Lunul JSON RPC](/docs/rpc). You can
...
interact with any of the Lunul JSON RPC API.

#### Example Usage

```javascript
const web3 = require("@lunul/web3.js");
...
[source generated docs](https://lunul-labs.github.io/lunul-web3.js/v1.x/classes/Connection.html)
for the full list.

### Transaction

[Source Documentation](https://lunul-labs.github.io/lunul-web3.js/v1.x/classes/Transaction.html)

A transaction is used to interact with programs on the Lunul blockchain. These
...
// Airdrop LUN for paying transactions
let payer = web3.Keypair.generate();
let connection = new web3.Connection(web3.clusterApiUrl("devnet"), "confirmed");

let airdropSignature = await connection.requestAirdrop(
  payer.publicKey,
  web3.LAMPORTS_PER_LUN,
);
...
[Source Documentation](https://lunul-labs.github.io/lunul-web3.js/v1.x/classes/Keypair.html)

The keypair is used to create an account with a public key and secret key within
Lunul. You can either generate, generate from a seed, or create from a secret
key.

#### Example Usage

```javascript
const { Keypair } = require("@lunul/web3.js");
...
Using `generate` generates a random Keypair for use as an account on Lunul.
...
[Source Documentation](https://lunul-labs.github.io/lunul-web3.js/v1.x/classes/PublicKey.html)

PublicKey is used throughout `@lunul/web3.js` in transactions, keypairs, and
programs. You require publickey when listing each account in a transaction and
as a general identifier on Lunul.
...
[Source Documentation](https://lunul-labs.github.io/lunul-web3.js/v1.x/classes/SystemProgram.html)
...
[Source Documentation](https://lunul-labs.github.io/lunul-web3.js/v1.x/classes/Secp256k1Program.html)
...
[Source Documentation](https://lunul-labs.github.io/lunul-web3.js/v1.x/classes/Message.html)
...
part of a transaction. A [Transaction](/docs/clients/javascript#transaction)
...
[Source Documentation](https://lunul-labs.github.io/lunul-web3.js/v1.x/classes/Struct.html)
...
import { Struct } from "@lunul/web3.js";
...
[Source Documentation](https://lunul-labs.github.io/lunul-web3.js/v1.x/classes/Enum.html)
...
```javascript
import { Enum } from "@lunul/web3.js";
...
[Source Documentation](https://lunul-labs.github.io/lunul-web3.js/v1.x/classes/NonceAccount.html)
...
[Source Documentation](https://lunul-labs.github.io/lunul-web3.js/v1.x/classes/VoteAccount.html)
...
[Source Documentation](https://lunul-labs.github.io/lunul-web3.js/v1.x/classes/StakeProgram.html)

The StakeProgram facilitates staking LUN and delegating them to any validators
on the network. You can use StakeProgram to create a stake account, stake some
LUN, authorize accounts for withdrawal of your stake, deactivate your stake, and
...
[Source Documentation](https://lunul-labs.github.io/lunul-web3.js/v1.x/classes/Authorized.html)

Authorized is an object used when creating an authorized account for staking
within Lunul. You can designate a `staker` and `withdrawer` separately,
...
[Source Documentation](https://lunul-labs.github.io/lunul-web3.js/v1.x/classes/Lockup.html)
