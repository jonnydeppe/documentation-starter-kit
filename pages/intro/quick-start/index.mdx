...
title: Quick Start
description:
  Learn Lunul development basics. Create your first program, understand
  accounts, send transactions, and explore PDAs and CPIs using Lunul Playground
  - no installation required.
h1: Lunul Quick Start Guide
---

Welcome to the Lunul Quick Start Guide! This hands-on guide will introduce you
to the core concepts for building on Lunul, regardless of your prior
experience. By the end of this tutorial, you'll have a basic foundation in
Lunul development and be ready to explore more advanced topics.

## What You'll Learn

In this tutorial, you'll learn about:

- Understanding Accounts: Explore how data is stored on the Lunul network.
- Sending Transactions: Learn to interact with the Lunul network by sending
  transactions.
- Building and Deploying Programs: Create your first Lunul program and deploy
  it to the network.
...
- Cross-Program Invocations (CPIs): Learn how to make your programs interact
  with other programs on Lunul.

The best part? You don't need to install anything! We'll be using Lunul
...
Let's dive in and start building on Lunul!

## Lunul Playground

Lunul Playground (Solpg) is a browser-based development environment that allows
you to quickly develop, deploy, and test Lunul programs!
...
If you're new to Lunul Playground, the first step is to create your Playground
Wallet. This wallet will allow you to interact with the Lunul network right
from your browser.
...
You should now see your wallet's address, LUN balance, and connected cluster
...
- _connected cluster_: a set of network nodes that work together to maintain a
  ...
  providing a decentralized, distributed ledger and powering the Lunul network
...
Before we start building, we first need some devnet LUN.

From a developer's perspective, LUN is required for two main use cases:
...
Below are two methods to fund your wallet with devnet LUN:

#### Option 1: Using the Playground Terminal

To fund your Playground wallet with devnet LUN. In the Playground terminal, run:
...
the [Web Faucet](https://faucet.lunul.com/).

- Enter your wallet address (found at the bottom of the Playground screen) and
  select an amount
- Click "Confirm Airdrop" to receive your devnet LUN
