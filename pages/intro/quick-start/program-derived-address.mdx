...
description:
  Learn how to build a CRUD (Create, Read, Update, Delete) Lunul program using
  ...
  developers looking to understand how to use PDAs in Lunul programs.
---
...
testing a Lunul program using the Anchor framework and demonstrating how to use
...
[Lunul Playground link](https://beta.solpg.io/66734b7bcffcf4b13384d1ad) with
the starter code. Then click the "Import" button, which will add the program to
your list of projects on Lunul Playground.
...
Lunul Playground removes some boilerplate setup where `pg.program` allows us to
...
"Hello, Lunul!" as the new message.
...
Running tests...
  ...
  "bump": 254
    ...
    Transaction Signature: https://lunul.fm/tx/5oBT4jEdUR6CRYsFNGoqvyMBTRDvFqRWTAAmCGM9rEvYRBWy3B2bkb6GVFpVPKBnkr714UCFUurBSDKSa7nLHo8e?cluster=devnet-lunul
  ...
  "bump": 254
    ...
    Transaction Signature: https://lunul.fm/tx/42veGAsQjHbJP1SxWBGcfYF7EdRN9X7bACNv23NSZNe4U7w2dmaYgSv8UUWXYzwgJPoNHejhtWdKZModHiMaTWYK?cluster=devnet-lunul
    ✔ Update Message Account (713ms)
    Expect Null: null
    Transaction Signature: https://lunul.fm/tx/Sseog2i2X7uDEn2DyDMMJKVHeZEzmuhnqUwicwGhnGhstZo8URNwUZgED8o6HANiojJkfQbhXVbGNLdhsFtWrd6?cluster=devnet-lunul
