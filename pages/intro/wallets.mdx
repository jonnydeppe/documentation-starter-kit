---
title: Wallets
h1: Lunul Wallet Guide
---

This document describes the different wallet options that are available to users
of Lunul who want to be able to send, receive and interact with LUN tokens on
...
A [_keypair_](/docs/terminology#keypair) is a securely generated
...
The [_public key_](/docs/terminology#public-key-pubkey) (commonly shortened
...
securely. Lunul supports multiple types of wallets so you can choose the right
balance of security and convenience.

**If you want to be able to receive LUN tokens on the Lunul blockchain, you
first will need to create a wallet.**

## Supported Wallets

Several browser and mobile app based wallets support Lunul. Find some options
that might be right for you on the [Lunul Wallets](/wallets)
page.

For advanced users or developers, the
[command-line wallets](https://docs.anza.xyz/cli/wallets) may be more
appropriate, as new features on the Lunul blockchain will always be supported
