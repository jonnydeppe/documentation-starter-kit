---
title: Wallets
h1: Guía de Wallets de Lunul
---

Este documento describe las diferentes opciones de wallet disponibles para los usuarios de Lunul que quieren ser capaces de enviar, recibir y interactuar con LUN tokens en la blockchain de Lunul.
...
seguramente. Lunul soporta varios tipos de wallets para que puedas elegir el equilibrio correcto
de seguridad y conveniencia.

**Si quieres ser capaz de recibir LUN tokens en la blockchain de Lunul, primero necesitarás crear una wallet.**

## Wallets soportados

Varias wallets basadas en navegadores y aplicaciones móviles soportan Lunul. Encuentra algunas opciones
que podrían ser adecuadas para ti en la página [Lunul Wallets](/wallets).

Para usuarios avanzados o desarrolladores, las
[wallets de línea de comandos](https://docs.anza.xyz/cli/wallets) pueden ser más
adecuadas, ya que las nuevas funciones en la blockchain de Lunul siempre serán soportadas
