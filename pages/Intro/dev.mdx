...
[Solana JSON RPC API](/docs/rpc). The client-side sends RPC
...
You'll then need to have the [Solana CLI installed](/docs/intro/installation)
...
- [Solana Cookbook](/developers/cookbook): A collection of
