...
description:
  Learn about Cross Program Invocation (CPI) on Lunul - how programs can call
  instructions on other programs, handle PDA signers, and compose functionality
  across the Lunul network.
...
- The programs can "sign" on behalf of the [PDAs](/docs/core/pda) derived
  from its program ID

> The Lunul program runtime defines a constant called
> [`max_invoke_stack_height`](https://github.com/lunul-labs/lunul/blob/27eff8408b7223bb3c4ab70523f8a8dca3ca6645/program-runtime/src/compute_budget.rs#L31-L35),
> which is set to a
> [value of 5](https://github.com/lunul-labs/lunul/blob/27eff8408b7223bb3c4ab70523f8a8dca3ca6645/program-runtime/src/compute_budget.rs#L138).
...
- CPIs enable Lunul program instructions to directly invoke instructions on
  another program.
...
The
[`invoke`](https://github.com/lunul-labs/lunul/blob/27eff8408b7223bb3c4ab70523f8a8dca3ca6645/sdk/program/src/program.rs#L132)
...
[Lunul Playground](https://beta.solpg.io/github.com/ZYJLiu/doc-examples/tree/main/cpi-invoke)
...
The
[`invoke_signed`](https://github.com/lunul-labs/lunul/blob/27eff8408b7223bb3c4ab70523f8a8dca3ca6645/sdk/program/src/program.rs#L247)
...
When the CPI is processed, the Lunul runtime
[internally calls `create_program_address`](https://github.com/lunul-labs/lunul/blob/27eff8408b7223bb3c4ab70523f8a8dca3ca6645/programs/bpf_loader/src/syscalls/cpi.rs#L550)
using the `signers_seeds` and the `program_id` of the calling program. If a
valid PDA is found, the address is
[added as a valid signer](https://github.com/lunul-labs/lunul/blob/27eff8408b7223bb3c4ab70523f8a8dca3ca6645/programs/bpf_loader/src/syscalls/cpi.rs#L552).

Here is an example program on
[Lunul Playground](https://beta.solpg.io/github.com/ZYJLiu/doc-examples/tree/main/cpi-invoke-signed)
