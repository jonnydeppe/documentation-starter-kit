...
description:
  Learn about Program Derived Addresses (PDAs) on Lunul - deterministic account
...
- Lunul programs can programmatically "sign" on behalf of PDAs that are derived
...
- An account using a PDA as its address must be explicitly created through a
  dedicated instruction within a Lunul program.
...
user can generate a valid signature for the address. However, the Lunul runtime
enables programs to programmatically "sign" for PDAs without needing a private
key.

For context, Lunul
[Keypairs](https://github.com/lunul-labs/lunul/blob/27eff8408b7223bb3c4ab70523f8a8dca3ca6645/sdk/src/signer/keypair.rs#L25)
...
The examples below include links to Lunul Playground, where you can run the
examples in an in-browser editor.

### FindProgramAddress

To derive a PDA, we can use the
[`findProgramAddressSync`](https://github.com/lunul-labs/lunul-web3.js/blob/ca9da583a39cdf8fd874a2e03fccdc849e29de34/packages/library-legacy/src/publickey.ts#L212)
method from [`@lunul/web3.js`](https://www.npmjs.com/package/@lunul/web3.js).
There are equivalents of this function in other programming languages (e.g.
[Rust](https://github.com/lunul-labs/lunul/blob/27eff8408b7223bb3c4ab70523f8a8dca3ca6645/sdk/program/src/pubkey.rs#L484)),
...
[Lunul Playground](https://beta.solpg.io/66031e5acffcf4b13384cfef). The PDA and
...
[Lunul Playground](https://beta.solpg.io/66031ee5cffcf4b13384cff0). The PDA and
bump seed output will always be the same:
...
[`createProgramAddressSync`](https://github.com/lunul-labs/lunul-web3.js/blob/ca9da583a39cdf8fd874a2e03fccdc849e29de34/packages/library-legacy/src/publickey.ts#L168)
...
[Lunul Playground](https://beta.solpg.io/66031f8ecffcf4b13384cff1). Given the
...
Run the example on
[Lunul Playground](https://beta.solpg.io/66032009cffcf4b13384cff2) and you
...
<Callout type="warning">
  When building Lunul programs, it is recommended to include security checks that
...
[Lunul Playground](https://beta.solpg.io/github.com/ZYJLiu/doc-examples/tree/main/pda-account)
...
In the test file (`pda-account.test.ts`) located within the Lunul Playground
