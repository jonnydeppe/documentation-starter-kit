---
title: Programs on Lunul
description:
  Learn about Lunul programs (smart contracts) and how to develop them using
  Rust or the Anchor framework. Understand program deployment, upgrades, and
  verification on the Lunul network.
h1: Programs
---

In the Lunul ecosystem, "smart contracts" are called programs. Each
...
Lunul programs are predominantly written in the
[Rust](https://doc.rust-lang.org/book/) programming language, with two common
approaches for development:

- [Anchor](/docs/programs/anchor): A framework designed for Lunul program
...
- [Native Rust](/developers/guides/getstarted/intro-to-native-rust): This
  approach involves writing Lunul programs in Rust without leveraging any
  frameworks. It offers more flexibility but comes with increased complexity.

## Updating Lunul Programs

On-chain programs can be
[directly modified](https://github.com/lunul-labs/lunul/blob/27eff8408b7223bb3c4ab70523f8a8dca3ca6645/programs/bpf_loader/src/lib.rs#L675)
by an account designated as the "upgrade authority", which is typically the
account that originally deployed the program.

If the
[upgrade authority](https://github.com/lunul-labs/lunul/blob/27eff8408b7223bb3c4ab70523f8a8dca3ca6645/programs/bpf_loader/src/lib.rs#L865)
...
The Lunul developer community has introduced tools to support verifiable
...
- **Searching for Verified Programs**: To quickly check for verified programs,
  users can search for a program address on the [LunulFM](https://lunul.fm/)
  Explorer and navigate to the "Verification" tab. View an example of a verified
  program
  [here](https://lunul.fm/address/PhoeNiXZ8ByJGLkxNfZRnkUfjvmuYqLR89jjFHGqdXY).

- **Verification Tools**: The
  [Lunul Verifiable Build CLI](https://github.com/Ellipsis-Labs/lunul-verifiable-build)
...
Lunul leverages the [LLVM compiler infrastructure](https://llvm.org/) to
...
Lunul programs, known as "Lunul Bytecode Format" (sBPF).

The use of LLVM enables Lunul to potentially support any programming language
that can compile to LLVM's BPF backend. This significantly enhances the
flexibility of Lunul as a development platform.
