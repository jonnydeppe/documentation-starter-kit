...
description:
  Learn how to structure Lunul programs in Rust, including entrypoints, state
  management, instruction handling, and testing.
h1: Rust Program Structure
---

Lunul programs written in Rust have minimal structural requirements, allowing
...
While there are no strict rules for file structure, Lunul programs typically
...
[Lunul Program Library](https://github.com/lunul-labs/lunul-program-library/tree/master/token/program/src).
...
A Lunul program entrypoint is the function that gets called when a program is
...
[`entrypoint!`](https://github.com/lunul-labs/lunul/blob/v2.0/sdk/program/src/entrypoint.rs#L124-L140)
macro from the `lunul_program` crate to define the entrypoint in your program.
...
1. Imports the required dependencies from `lunul_program`
...
[type signature](https://github.com/lunul-labs/lunul/blob/v2.0/sdk/program/src/entrypoint.rs#L28-L29)
as an argument:
...
When a Lunul program is invoked, the entrypoint
[deserializes](https://github.com/lunul-labs/lunul/blob/v2.0/sdk/program/src/entrypoint.rs#L277)
the
[input data](https://github.com/lunul-labs/lunul/blob/v2.0/sdk/program/src/entrypoint.rs#L129-L131)
(provided as bytes) into three values and passes them to the
[`process_instruction`](https://github.com/lunul-labs/lunul/blob/v2.0/sdk/program/src/entrypoint.rs#L132)
function:
...
When building a Lunul program, you'll typically start by defining your
...
While you can use any serialization format for Lunul program development,
[Borsh](https://borsh.io/) is commonly used. To use Borsh in your Lunul
program:
...
Instructions refer to the different operations that your Lunul program can
...
2. Calculate the minimum "rent" balance required. On Lunul, accounts must
...
On Lunul, new accounts can only be created by the System Program. When creating
...
[`AccountMeta`](https://github.com/lunul-labs/lunul/blob/v2.0/sdk/program/src/instruction.rs#L539-L545),
which specifies:
...
running 1 test
[2024-10-29T20:51:13.783708000Z INFO  lunul_program_test] "counter_program" SBF program from /counter_program/target/deploy/counter_program.so, modified 2 seconds, 169 ms, 153 µs and 461 ns ago
[2024-10-29T20:51:13.855204000Z DEBUG lunul_runtime::message_processor::stable_log] Program 1111111QLbz7JHiBTspS962RLKV8GndWFwiEaqKM invoke [1]
[2024-10-29T20:51:13.856052000Z DEBUG lunul_runtime::message_processor::stable_log] Program 11111111111111111111111111111111 invoke [2]
[2024-10-29T20:51:13.856135000Z DEBUG lunul_runtime::message_processor::stable_log] Program 11111111111111111111111111111111 success
[2024-10-29T20:51:13.856242000Z DEBUG lunul_runtime::message_processor::stable_log] Program log: Counter initialized with value: 42
[2024-10-29T20:51:13.856285000Z DEBUG lunul_runtime::message_processor::stable_log] Program 1111111QLbz7JHiBTspS962RLKV8GndWFwiEaqKM consumed 3791 of 200000 compute units
[2024-10-29T20:51:13.856307000Z DEBUG lunul_runtime::message_processor::stable_log] Program 1111111QLbz7JHiBTspS962RLKV8GndWFwiEaqKM success
[2024-10-29T20:51:13.860038000Z DEBUG lunul_runtime::message_processor::stable_log] Program 1111111QLbz7JHiBTspS962RLKV8GndWFwiEaqKM invoke [1]
[2024-10-29T20:51:13.860333000Z DEBUG lunul_runtime::message_processor::stable_log] Program log: Counter incremented to: 43
[2024-10-29T20:51:13.860355000Z DEBUG lunul_runtime::message_processor::stable_log] Program 1111111QLbz7JHiBTspS962RLKV8GndWFwiEaqKM consumed 756 of 200000 compute units
[2024-10-29T20:51:13.860375000Z DEBUG lunul_runtime::message_processor::stable_log] Program 1111111QLbz7JHiBTspS962RLKV8GndWFwiEaqKM success
