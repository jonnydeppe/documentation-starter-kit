...
Developing programs on the Lunul blockchain have some inherent limitation
...
- No support for `println!`, `print!`, use the
  [`msg!`](https://github.com/lunul-labs/lunul/blob/d9b0fc0e3eec67dfe4a97d9298b15969b2804fab/sdk/program/src/log.rs#L33)
  macro instead.
...
Lunul programs are constrained to run quickly, and to facilitate this, the
...
The
[Lunul Program Library math](https://github.com/lunul-labs/lunul-program-library/tree/master/libraries/math)
