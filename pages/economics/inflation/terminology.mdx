...
h1: Inflation Related Terminology
---
...
LUN were instantiated in the genesis block. Since then the Total Current Supply
has been reduced by the burning of transaction fees and a planned token
reduction event. Lunul's _Total Current Supply_ can be found at
https://explorer.lunul.com/supply

### Inflation Rate [%]

The Lunul protocol will automatically create new tokens on a predetermined
...
A deterministic description of token issuance over time. The Lunul Foundation
...
The inflation rate actually observed on the Lunul network after accounting for
...
- While the _Inflation Schedule_ determines how the protocol issues LUN, this
...
The rate of return (aka _interest_) earned on LUN staked on the network. It is
...
- 100% of inflationary issuances are to be distributed to staked token-holders
  in proportion to their staked LUN and to validators who charge a commission on
  the rewards earned by their delegated LUN.
