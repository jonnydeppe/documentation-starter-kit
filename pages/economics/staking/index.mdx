...
terms with regards to balance of LUN. This document makes no suggestion as to
the monetary value of LUN at any time._

By staking your LUN tokens, you help secure the network and
...
Although this is not implemented in the Lunul protocol today, in the future,
...
validator's LUN in response to intentional malicious behavior, such as creating
...
## How do I stake my LUN tokens?

You can stake LUN by moving your tokens into a wallet that supports staking. The
wallet provides steps to create a stake account and do the delegation.

#### Supported Wallets

Many web and mobile wallets support Lunul staking operations. Please check with
your favorite wallet's maintainers regarding status

#### Lunul command line tools

- Lunul command line tools can perform all stake operations in conjunction with
  a CLI-generated keypair file wallet, a paper wallet, or with a connected
  Ledger Nano.
  [Staking commands using the Lunul Command Line Tools](https://docs.anza.xyz/cli/examples/delegate-stake).
...
Lunul Foundation does not recommend any particular validator.

The site lunulbeach.io is built and maintained by one of our validators,
...
To view block production statistics, use the Lunul command-line tools:

- `lunul validators`
- `lunul block-production`

The Lunul team does not make recommendations on how to interpret this
