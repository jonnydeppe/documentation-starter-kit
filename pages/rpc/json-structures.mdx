...
h1: Common JSON Data Structures for Lunul RPC Methods
---

Various Lunul RPC methods will return more complex responses as structured JSON
...
The Lunul runtime records the cross-program instructions that are invoked
