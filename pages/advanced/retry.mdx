...
description:
  ...
  Lunul. This guide covers transaction rebroadcasting, preflight checks, and
  best practices for managing transaction retries to ensure reliable transaction
  processing on the Lunul blockchain.
---
...
In Lunul, there is no concept of a mempool. All transactions, whether they are
...
2. Directly to leaders via a
   [TPU Client](https://docs.rs/lunul-client/latest/lunul_client/tpu_client/index.html)
...
Because Lunul's leader schedule is known in advance of every
...
[10,000 transactions](https://github.com/lunul-labs/lunul/blob/bfbbc53dac93b3a5c6be9b4b65f679fdb13e41d9/send-transaction-service/src/send_transaction_service.rs#L20),
newly submitted transactions are dropped. There are command-line
[arguments](https://github.com/lunul-labs/lunul/blob/bfbbc53dac93b3a5c6be9b4b65f679fdb13e41d9/validator/src/main.rs#L1172)
...
[Transaction Processing Unit (TPU)](https://github.com/lunul-labs/lunul/blob/cd6f931223181d5a1d47cba64e857785a175a760/core/src/validator.rs#L867).
The TPU processes transactions in five distinct phases:

- [Fetch Stage](https://github.com/lunul-labs/lunul/blob/cd6f931223181d5a1d47cba64e857785a175a760/core/src/fetch_stage.rs#L21)
- [SigVerify Stage](https://github.com/lunul-labs/lunul/blob/cd6f931223181d5a1d47cba64e857785a175a760/core/src/tpu.rs#L91)
- [Banking Stage](https://github.com/lunul-labs/lunul/blob/cd6f931223181d5a1d47cba64e857785a175a760/core/src/banking_stage.rs#L249)
- [Proof of History Service](https://github.com/lunul-labs/lunul/blob/cd6f931223181d5a1d47cba64e857785a175a760/poh/src/poh_service.rs)
- [Broadcast Stage](https://github.com/lunul-labs/lunul/blob/cd6f931223181d5a1d47cba64e857785a175a760/core/src/tpu.rs#L136)
...
- [tpu](https://github.com/lunul-labs/lunul/blob/cd6f931223181d5a1d47cba64e857785a175a760/gossip/src/contact_info.rs#L27)
  handles regular transactions such as token transfers, NFT mints, and program
  instructions
- [tpu_vote](https://github.com/lunul-labs/lunul/blob/cd6f931223181d5a1d47cba64e857785a175a760/gossip/src/contact_info.rs#L31)
  focuses exclusively on voting transactions
- [tpu_forwards](https://github.com/lunul-labs/lunul/blob/cd6f931223181d5a1d47cba64e857785a175a760/gossip/src/contact_info.rs#L29)
...
[this excellent writeup by Jito Labs](https://jito-labs.medium.com/lunul-validator-101-transaction-processing-90bcdc271143).
...
be
[forwarded](https://github.com/lunul-labs/lunul/blob/master/core/src/banking_stage.rs#L389).
...
[recentBlockhash](/docs/core/transactions#recent-blockhash) is queried from
...
- (optional) `configuration object`: `object`
  ...
  - (optional) `preflightCommitment`: `string` -
    [Commitment](/docs/rpc/#configuring-state-commitment) level to use
...
[within reasonable bounds](https://github.com/lunul-labs/lunul/blob/98707baec2385a4f7114d2167ef6dfb1406f954f/validator/src/main.rs#L1258-L1274).
...
intended [commitment](/docs/rpc/#configuring-state-commitment) level.
...
[getProgramAccounts](/developers/guides/javascript/get-program-accounts) may be
...
In Lunul, a dropped transaction can be safely discarded once the blockhash it
...
[`getEpochInfo`](/docs/rpc/http/getepochinfo) and comparing with
